$(document).ready(function($){
	...
	function initHeadline() {
        var animationText = $('.cd-headline');
		//insert <i> element for each letter of a changing word
		singleLetters($('.cd-headline.letters').find('b'));
		//initialise headline animation
		animateHeadline(animationText);
		setAnimationInterval(animationText);
	}
    ...
    function setEqualHeight(){
        $('.cd-headline').each(function(){
            ...
            $(this).find('b').css('min-height',height);
        });
    }
	...
	function setAnimationInterval($headlines){
        setTimeout(function(){
            $headlines.each(function(){
                var headline = $(this);
	...
	function switchWord($oldWord, $newWord) {
        ...
        if( $newWord ) $newWord.removeClass('is-hidden').addClass('is-visible');
	}
});