...
var headerSectionScrollObj = {
    ...
    _onScrollHandler: function(){
        var headerSectionBottomPos = this.headerSection.offset().top + this.headerSection.height() + 20;
        var introHeaderTopPos = this.introHeader.offset().top;
        if (headerSectionBottomPos > introHeaderTopPos) {
            this.headerSection.addClass("sticky");
        }
        else {
            this.headerSection.removeClass("sticky");
        }
    },
    _navClickHandler: function(){
        ...
        if (!body.hasClass("mobile-no-scroll")) {
            ...
            if (!header.hasClass("sticky")){
                header.addClass("sticky burgered");
            }
        }
        else {
            nav.removeClass("active");
            if (header.hasClass("burgered")) {
                header.removeClass("sticky burgered");
            }
        }
    ...
    init: function(){
        ...
        this.introHeader = $(".intro h1");
        this.nav = $("nav");
        this.tabletBrkp = window.matchMedia("(min-width: 931px)");

        this.tabletBrkp.addListener(function(e){
            if (e.matches) {
                this.nav.removeClass("transitioned");
            }
            else {
                this.nav.addClass("transitioned");
            }
            this.nav.removeClass("active");
            $("body").removeClass("mobile-no-scroll");
            headerSectionScrollObj._onScrollHandler();
        }.bind(this));

        if (!this.tabletBrkp.matches) {
            this.nav.addClass("transitioned");
        }
        ...
        $(document).on('scroll', this._onScrollHandler.bind(this));
        ...
        $(document).on('click', '.bg-layer', function(event){
            this._navClickHandler();
        }.bind(this));

        $(document).on('click', '.nav-link', function(event){
            event.preventDefault();
            var scrollPoint = $('.info-section.' + $(event.currentTarget).data("href")).offset().top - headerSectionScrollObj.headerSection.height() - 40;
