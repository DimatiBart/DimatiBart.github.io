...
$(window).load(function(){
    ...
    if (homeHero.length) {
        ...
        var lastIndex = $('.home-hero-carousel-module .swiper-container.second .swiper-slide').length;

        homeHeroSwiperSecond =  new Swiper('.home-hero-carousel-module .swiper-container.second', {
            direction: 'vertical',
            loop: true,
            simulateTouch: false,
            initialSlide: lastIndex - 1
        });
        ...
        $(document).on('click', '.home-hero-carousel-module .paginator', function(){
            ...
            if (!$this.hasClass('active')) {
                ...
                homeHeroSwiperSecond.slideTo(lastIndex - index);
            }
        });
    }
});
